...
test_net <- plot_ggraph(input_igraph = test_net, edge_color = "rho", edge_width = "log_p", scale = "diverge", render = F)

### SLOWER : Render = T, without labels
test_net <- plot_ggraph(input_igraph = test_net, edge_color = "rho", edge_width = "log_p", scale = "diverge", render = T, label = F)
